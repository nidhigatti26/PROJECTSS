...
<head>
    ...
    <?php 
     ...
     submit($f_name,$l_name,$email,$phone,$location,$time_slot);
...
<div class="container">
    <div class="row py-5 mt-4 align-items-center">
      ...
      <div class="col-md-5 pr-lg-5 mb-5 mb-md-0" >
        ...
        <img src="images/dasher1.jpg" style="width: 25em;;height: 25em;margin-left: 1em;" alt="" class="img-fluid mb-3 d-none d-md-block">
      ...
      <form action="" method="POST">
          ...
          <div class="row">
            ...
            <div class="input-group col-lg-12 mb-4">
              ...
              <select style="height: 3.5em;"  id="job" name="location" class="form-control custom-select bg-white border-left-0 border-md" required>
              ...
              <div class="input-group col-lg-12 mb-4">
                ...
                <select style="height: 3.5em;" id="jobloc" name="time_slot" class="form-control custom-select bg-white border-left-0 border-md" required>
                  <option value="">Choose your preferred slot</option>
                  <option value="8 a.m - 12 p.m">8 a.m - 12 p.m</option>
                  <option value="12 p.m - 4 p.m">12 p.m - 4 p.m</option>
                  <option value="4 p.m - 8 p.m">4 p.m - 8 p.m</option>
                  <option value="8 p.m - 12 a.m">8 p.m - 12 a.m</option>
                </select>
              </div>
            ...
            <div class="form-group col-lg-12 mx-auto mb-0">
              ...
              <button  style="background-color:#FD4756;width:33.5em;margin-left:0.3em;height:2.9em;color:white;border-color:#fd4756;" name="submit">Join us</button>
              </a>
            </div>
