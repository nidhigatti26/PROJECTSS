...
<!-- category -->
    ...
    <div class="container my-4 ">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card mb-2">
            <img class="card-img-top" src="images/mudcake.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
              <h4 class="card-title">Mud Cake</h4>
        ...
        <div class="col-md-4 clearfix d-none d-md-block">
          <div class="card mb-2">
            <img class="card-img-top" src="images/bananamuffins.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
        ...
        <div class="col-md-4 clearfix d-none d-md-block">
          <div class="card mb-2">
            <img class="card-img-top" src="images/mangomousse.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
              <h4 class="card-title">Mango Mousse</h4>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
              <a class="btn btn-primary">View Recipe</a>
            </div>
...
<div class="container my-4 ">
    <div class="row">
        <div class="col-md-4">
          <div class="card mb-2">
            <img class="card-img-top" src="images/applepie.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
        ...
        <div class="col-md-4 clearfix d-none d-md-block">
          <div class="card mb-2">
            <img class="card-img-top" src="images/triflepudding.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
              <h4 class="card-title">Trifle Pudding</h4>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
              <a class="btn btn-primary">View Recipe</a>
            </div>
        ...
        <div class="col-md-4 clearfix d-none d-md-block">
          <div class="card mb-2">
            <img class="card-img-top" src="images/mawacake.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
              <h4 class="card-title">Mawa Cake</h4>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
              <a class="btn btn-primary">View Recipe</a>
            </div>
