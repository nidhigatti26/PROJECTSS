...
<head>
    ...
    <?php 
     ...
     submit2($f_name,$l_name,$email,$field,$knowledge,$experience,$phone);
...
<div class="container">
    <div class="row py-5 mt-4 align-items-center">
      ...
      <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
        ...
        <img src="images/grabajob.jpg" style="width: 33em;height: 25em;margin-left: 1em;" alt="" class="img-fluid mb-3 d-none d-md-block">
      ...
      <form action="" method="POST">
          <div class="row">
            ...
            <div class="input-group col-lg-12 mb-4">
                ...
                <select style="height: 3.5em;" id="jobloc" name="field" class="form-control custom-select bg-white border-left-0 border-md" required>
            ...
            <div class="input-group col-lg-12 mb-4">
                ...
                <textarea class="form-control" name="knowledge" placeholder="Tell Us About Your Knowledge" aria-label="With textarea" required></textarea>
              </div>
            ...
            <div class="input-group col-lg-12 mb-4">
                ...
                <textarea class="form-control" name="experience" placeholder="Tell Us About Your Experience" aria-label="With textarea" required></textarea>
              </div>
            ...
            <div class="form-group col-lg-12 mx-auto mb-0">
              ...
              <button  style="background-color:#FD4756;width:33.5em;margin-left:0.3em;height:2.9em;color:white;border-color:#fd4756;" name="submit2">Join us</button>
