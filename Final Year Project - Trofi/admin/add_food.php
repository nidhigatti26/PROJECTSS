...
<head>
    ...
    if(isset($_POST['submit'])){
        ...
        $image = $path;
        add_food($name,$price,$disc,$image);
    }
                ...
                <div class="card-body">
                    <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea type="text" name="disc" class="form-control" required></textarea>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-2">
                            <button type="submit" name="submit" class="btn btn-primary mt-2 btn-block">Add</button>
                        </div>
                    </form>
                </div>
            </div>
