  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #FEC24A;">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ">
        ...
        <a class="nav-item nav-link cat ml-5" href="main course.php" style="font-family: 'Courgette', cursive;font-size: 22px;">Main Course</a>
...
<!-- category -->
    ...
    <div class="container my-4 ">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card mb-2">
            <img class="card-img-top" src="images/lassi.jfif"
        ...
        <div class="col-md-4 clearfix d-none d-md-block">
          <div class="card mb-2">
            <img class="card-img-top" src="images/mangofalooda.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
              <h4 class="card-title">Mango Falooda</h4>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
              <a class="btn btn-primary">View Recipe</a>
            </div>
        ...
        <div class="col-md-4 clearfix d-none d-md-block">
          <div class="card mb-2">
            <img class="card-img-top" src="images/aampanna.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
              <h4 class="card-title">Aam Panna</h4>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
              <a class="btn btn-primary">View Recipe</a>
            </div>
...
<div class="container my-4 ">
    <div class="row">
        <div class="col-md-4">
          <div class="card mb-2">
            <img class="card-img-top" src="images/paanshots.jfif"
              alt="Card image cap"  style="width:350px;height:230px;">
            <div class="card-body">
              <h4 class="card-title">Paan Shots</h4>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
              <a class="btn btn-primary">View Recipe</a>
            </div>
        ...
        <div class="col-md-4 clearfix d-none d-md-block">
          <div class="card mb-2">
            <img class="card-img-top" src="images/lemonmojito.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
              <h4 class="card-title">Lemon Mojito</h4>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
              <a class="btn btn-primary">View Recipe</a>
            </div>
        ...
        <div class="col-md-4 clearfix d-none d-md-block">
          <div class="card mb-2">
            <img class="card-img-top" src="images/pomegranatecooler.jfif"
              alt="Card image cap" style="width:350px;height:230px;">
            <div class="card-body">
              <h4 class="card-title">Pomegranate cooler</h4>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
              <a class="btn btn-primary">View Recipe</a>
            </div>
